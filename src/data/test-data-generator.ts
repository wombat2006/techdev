...
export class TestDataGenerator {
  ...
  generateMockCode(): string {
    const codeTemplates: readonly string[] = [
  ...
  generateTypeScriptParsingData(): {
    ...
    const codeStructures: TypeScriptStructure[] = [];
   ...
   */
  private generateComplexAlgorithmCode(): string {
  ...
  private generateEventManagerCode(): string {
  ...
  private generateLegacyCode(): string {
  ...
  private generateCodeBlock(size: number): string {
    if (size <= 0) {
      return '';
    }
