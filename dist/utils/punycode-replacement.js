...
class PunycodeReplacement {
     ...
     */
    static toASCII(domain) {
        try {
            return new url_1.URL(`http://${domain}`).hostname;
        }
        catch (error) {
...
exports.PunycodeReplacement = PunycodeReplacement;
/**
 * 廃止警告サプレッサー
 * Node.jsのpunycode deprecation warningを制御
 */
function suppressPunycodeWarnings() {
...
// デフォルトエクスポート
exports.default = PunycodeReplacement;
//# sourceMappingURL=punycode-replacement.js.map