...
exports.createOpenRouterQwen3Provider = exports.OpenRouterQwen3Provider = void 0;
const logger_1 = require("../utils/logger");
const environment_1 = require("../config/environment");
class OpenRouterQwen3Provider {
    name = 'openrouter-qwen3-coder';
    model = 'qwen/qwen3-coder';
    apiKey;
    baseUrl = 'https://openrouter.ai/api/v1';
    constructor() {
        this.apiKey = environment_1.config.openrouter.apiKey;
        if (!this.apiKey) {
    ...
    async invoke(prompt, options) {
        ...
        try {
            logger_1.logger.info('🤖 OpenRouter Qwen3-Coder実行開始', {
                model: this.model,
            ...
            logger_1.logger.info('✅ OpenRouter Qwen3-Coder実行成功', {
                processingTime,
            ...
            logger_1.logger.error('❌ OpenRouter Qwen3-Coder実行失敗', { error });
    ...
    calculateCost(inputTokens, outputTokens) {
        const inputCost = (inputTokens / 1000000) * 0.22;
        const outputCost = (outputTokens / 1000000) * 0.95;
    ...
    calculateConfidence(response) {
        ...
        if (hasCode)
            confidence += 0.15; // コーディング特化モデルとしてコード含有を高評価
        if (hasStructure)
            confidence += 0.05;
...
exports.OpenRouterQwen3Provider = OpenRouterQwen3Provider;
/**
 * ファクトリ関数
 */
const createOpenRouterQwen3Provider = () => {
    return new OpenRouterQwen3Provider();
};
exports.createOpenRouterQwen3Provider = createOpenRouterQwen3Provider;
//# sourceMappingURL=openrouter-qwen3-provider.js.map