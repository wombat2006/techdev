...
exports.mcpConfigManager = exports.MCPConfigManager = void 0;
...
class MCPConfigManager {
    ...
    initializeDefaultConfigurations() {
        ...
        logger_1.logger.info('🔧 MCP Configuration Manager initialized', {
     ...
     */
    getOptimizedToolsForContext(context) {
        const availableTools = [];
        const budgetLimits = this.costThresholds[context.budgetTier];
        logger_1.logger.info('🎯 Selecting optimized MCP tools', {
        ...
        for (const [toolName, priority] of toolPriorities) {
            if (availableTools.length >= budgetLimits.maxTools)
                break;
            ...
            if (!this.isSecurityLevelAllowed(toolConfig.security_level, context.securityLevel)) {
                logger_1.logger.debug('🚫 Tool filtered out by security level', {
                    tool: toolName,
            ...
            logger_1.logger.debug('✅ Tool selected', {
                tool: toolName,
                priority,
        ...
        logger_1.logger.info('🎯 Tool selection completed', {
    ...
    getToolPrioritiesForTask(taskType) {
        const priorities = {
            basic: {
    ...
    isSecurityLevelAllowed(toolLevel, contextLevel) {
    ...
    applyContextualOptimizations(config, context) {
     ...
     */
    estimateToolCosts(tools, estimatedCalls = 10) {
        const costPerCall = {
            free: 0,
            low: 0.0001,
            medium: 0.001,
     ...
     */
    getApprovalRequirement(toolName, operation, context) {
     ...
     */
    updateToolConfiguration(toolName, updates) {
        ...
        logger_1.logger.info('🔄 Tool configuration updated', {
            tool: toolName,
...
// Singleton instance
exports.mcpConfigManager = new MCPConfigManager();
exports.default = exports.mcpConfigManager;
