...
| Cursor MCP (TechSapo) | **not registered** | Phase 0: WSL `claude`/`codex`/`agy` + auth → [CURSOR_MCP_TODO.md](./CURSOR_MCP_TODO.md) |
...
| TS-21 | Cursor MCP | TechSapo providers in Cursor IDE | not registered | **Phase 0: WSL CLI + auth → Phase 1: MCP register** | [CURSOR_MCP_PLAN.md](./CURSOR_MCP_PLAN.md) · [CURSOR_MCP_TODO.md](./CURSOR_MCP_TODO.md) |
